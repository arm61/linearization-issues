...
\begin{figure}
  ...
  \caption{
    % Two parallel lines with linear (a) and logarithmic (b) $y$-axes that exemplify the distortion that logarithmic space can induce.
    % Scripts~\cite{mccluskey_github_2023} to generate this figure are available under CC BY 4.0/MIT licences. 
    }
