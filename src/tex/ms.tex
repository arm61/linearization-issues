...
Using the linearized form gives a biased estimate of $k$, with a normalised mean of \variable{output/lin_mean.txt}, with the magnitude of the bias increasing with increasing noise in the data.
