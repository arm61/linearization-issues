...
This leads to a normally distributed, but still biased distribution of $\hat{k}$ (Fig.~\ref{fig:wls}d), with a mean of \variable{output/lin_mean_wls.txt}.
We can see that this is not the case for the non-linear optimisation with a mean of \variable{output/non_mean_wls.txt}.
