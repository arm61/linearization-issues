...
\begin{abstract}
    The use of mathematical transformations to linearize non-linear functions is commonplace in chemistry textbooks and degree programs. 
    However, the use of linearization can lead to biased estimates of regression parameters, when real measured data is used. 
    Teaching students to perform linearization leads to researchers applying linearization in formal analysis; potentially biasing the result of their research. 
    Furthermore, with advances in computing and software, non-linear optimisation is easier than ever. 
