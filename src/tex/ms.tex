...
When the non-linear fitting is performed, the distribution of estimated values of the rate constant is normal with a mean value approximately equal to the true value of $k$ ($E(k) - k = \variable{outputs/non_bias.txt}$
%
\begin{figure}
