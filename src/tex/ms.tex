...
The true uncertainty, the width of the solid distribution, using WLS is found to be \variable{output/lin_err_true.txt}, however the mean estimated uncertainty over all $2^{15}$ WLS analyses is \variable{output/lin_err.txt}. 
