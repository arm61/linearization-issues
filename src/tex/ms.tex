...
The linearized form, however, gives a biased estimate of $k$, i.e., the normalised mean is \variable{output/lin_mean_ols.txt}, as well as broad, asymmetrical distribution of $k$. 
...
This approach leads to normal distribution of estimated $k$, but still the distribution is biased (Fig.~\ref{fig:wls}d), with a normalised mean of \variable{output/lin_mean_wls.txt}.
