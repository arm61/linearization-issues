...
The linearized form, however, gives a biased estimate of $k$ (the normalised mean is \variable{output/lin_mean_ols.txt}) as well as broad, asymmetrical distribution of $k$. 
...
This approach leads to a normally distributed, but still biased distribution of estimated $k$ (Fig.~\ref{fig:wls}d) (a normalised mean of \variable{output/lin_mean_wls.txt}).
