...
axes[-1].set_xlabel('$k_{\mathrm{lin}} k_{\mathrm{true}^{-1}$ / M$^{-1}$s$^{-1}$')
axes[-1].set_ylabel('$p(k_{\mathrm{lin}} k_{\mathrm{true}^{-1})$ / $10^{-2}$ Ms')
...
axes[-1].set_xlabel('$k_{\mathrm{non}} k_{\mathrm{true}^{-1}$ / M$^{-1}$s$^{-1}$')
axes[-1].set_ylabel('$p(k_{\mathrm{non}} k_{\mathrm{true}^{-1})$ / $10^{-2}$ Ms')
